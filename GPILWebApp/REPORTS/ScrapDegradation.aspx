...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center><h3 style="color:White; height:20%;" id=" ">SCRAP DEGRADATION </h3></center>
           ...
           <td colspan="12">&nbsp;</td>
            ...
            <td align="left"  >
                ...
                <asp:DropDownList ID="ddScrapGrade" runat="server" Height="24px" 
                    Width="153px" ontextchanged="txtScrapGrade_TextChanged"  ></asp:DropDownList>
           ...
           <tr>
            ...
            <td align="right" >
                <asp:Label ID="Label16" runat = "server" 
                     Text="Held Over 10 # %"  ForeColor="Black" style="text-align: left ;margin-right: 10px"></asp:Label> </td>
            <td align="left" >
           ...
           <td colspan="12">&nbsp;</td>
            ...
            <td align="right" >
                <asp:Label ID="Label18" runat = "server" 
                     Text="Pan %"  ForeColor="Black" style="text-align: left ;margin-right: 10px" ></asp:Label> </td>
            <td align="left" >
