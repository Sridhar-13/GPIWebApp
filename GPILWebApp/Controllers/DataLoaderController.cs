...
namespace GPILWebApp.Controllers
{
    public class DataLoaderController : Controller
    {
        ...
        //            purdata.Tables[s].Columns.Add("CROP");
        //            purdata.Tables[s].Columns.Add("VARIETY");
        //            purdata.Tables[s].Columns.Add("ATTRIBUTE2");
        ...
        //                        string rate1 = purdata.Tables[d].Rows[h]["RATE"].ToString();
        //                        string buyergrade1 = purdata.Tables[d].Rows[h]["BUYER_GRADE"].ToString();
        //                        string classification_grade1 = purdata.Tables[d].Rows[h]["ATTRIBUTE2"].ToString();
        //                        string rejests1 = purdata.Tables[d].Rows[h]["REJE_STATUS"].ToString();
        //                        string rejetype1 = purdata.Tables[d].Rows[h]["REJE_TYPE"].ToString();
        //                        //string pattacharge1 = purdata.Tables[d].Rows[h]["PATTA_CHARGE"].ToString();
        ...
        //            for (int d = 0; d < purdata.Tables.Count; d++)
        //            {
        //                string headerid = purdata.Tables[d].Rows[0]["ORGN_CODE"].ToString() + purdata.Tables[d].Rows[0]["PURCH_DOC_NO"].ToString().Substring(0, 8);
        //                string orgcd1 = purdata.Tables[d].Rows[0]["ORGN_CODE"].ToString();
        //                string byrcd = purdata.Tables[d].Rows[0]["BUYER_CODE"].ToString();
        //                string purchdoc = purdata.Tables[d].Rows[0]["PURCH_DOC_NO"].ToString();
        //                string dateofpurch = purdata.Tables[d].Rows[0]["PURCHASE_DATE"].ToString();
        ...
        //                    //strsql = strsql + "Values('" + baleno.Trim() + "','FW','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + buyergrade.Trim() + "','" + netwt.Trim() + "','" + netwt.Trim() + "','LOC1','" + orgcd.Trim() + "','" + crop + "','" + variety + "','" + rate.Trim() + "','G','Y','" + headerid + "','" + status + "','" + Session["userID"].ToString() + "',GETDATE(),'" + Session["userID"].ToString() + "',GETDATE(),'N','FARM','LOC1','" + orgcd + "','" + classification_grade1.Trim() + "')";
        ...
        //                    //if (rejetype == "NONE")
        //                    //{
        //                    //    strsql = strsql + "Values('" + headerid + "','" + baleno.Trim() + "','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + netwt.Trim() + "','" + rate.Trim() + "','" + totalprice + "','" + buyergrade.Trim() + "','" + crop + "','" + variety + "','FW','" + rejests + "',NULL,'" + status + "','N','" + Session["userID"].ToString() + "',GETDATE(),'" + classification_grade1.Trim() + "')";
        //                    //}
        //                    //else
        //                    //{
        //                    //    strsql = strsql + "Values('" + headerid + "','" + baleno.Trim() + "','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + netwt.Trim() + "','" + rate.Trim() + "','" + totalprice + "','" + buyergrade.Trim() + "','" + crop + "','" + variety + "','FW','" + rejests + "','" + rejetype + "','" + status + "','N','" + Session["userID"].ToString() + "',GETDATE(),'" + classification_grade1.Trim() + "')";
        //                    //}
        ...
        //                    //servicechargeshcessamt = (servicetaxamt * servicechargeshcess) / 100;
        //                    //totalservicetaxamt = servicetaxamt + servicechargeamt + servicechargeedshamt + servicechargeshcessamt;
        //                    strsql = "SELECT FREIGHT_CHARGE FROM gpil_farmer_freight_charge_master WHERE village_code = SUBSTRING('" + tbgrno + "', 1, 8) AND orgn_code = '" + orgcd1 + "'";
        //                    DataTable ds7 = new DataTable();
        //                    ds7 = dlMgt.GetQueryResult(strsql);
        //                    FreightRate = Convert.ToDouble(ds7.Rows[0][0]);
        //                    withFreightRate = Convert.ToDouble(rate) + Convert.ToDouble(FreightRate);
        //                    strsql = "insert into GPIL_STOCK(GPIL_BALE_NUMBER,SUBINVENTORY_CODE,TB_LOT_NO,TBGR_NO,TB_GRADE,BUYER_GRADE,MARKED_WT,CURR_WT,ORIGN_LOCN,ORIGN_ORGN_CODE,CROP,VARIETY,PRICE,PRODUCT_TYPE,PROCESS_STATUS,BATCH_NO,STATUS,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,WEIGHT_FLAG,BALE_CARD_TYPE,CURR_LOCN,CURR_ORGN_CODE,GRADE)";
        //                    strsql = strsql + "Values('" + baleno.Trim() + "','FW','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + buyergrade.Trim() + "','" + netwt.Trim() + "','" + netwt.Trim() + "','LOC1','" + orgcd.Trim() + "','" + crop + "','" + variety + "','" + rate.Trim() + "','G','Y','" + headerid + "','" + StockStatus + "','" + Session["userID"].ToString() + "',GETDATE(),'" + Session["userID"].ToString() + "',GETDATE(),'N','FARM','LOC1','" + orgcd + "','" + classification_grade1.Trim() + "')";
        //                    // dlMgt.UpdateUsingExecuteNonQuery(strsql);
        //                    lstString.Add(strsql);
        //                    strsql = "INSERT INTO [GPIL_TAP_FARM_PURCHS_DTLS]([HEADER_ID],[GPIL_BALE_NUMBER],[TB_LOT_NO],[FARMER_CODE],[TB_GRADE],[NET_WT],[RATE],[VALUE],[BUYER_GRADE] ,[CROP],[VARIETY],[SUBINVENTORY_CODE],[REJE_STATUS],[REJE_TYPE],[STATUS],[HEADER_STATUS] ,[CREATED_BY],[CREATED_DATE],[ATTRIBUTE2],ATTRIBUTE4)";
        //                    if (rejetype == "NONE")
        //                    {
        //                        strsql = strsql + "Values('" + headerid + "','" + baleno.Trim() + "','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + netwt.Trim() + "','" + withFreightRate + "','" + totalprice + "','" + buyergrade.Trim() + "','" + crop + "','" + variety + "','FW','" + rejests + "',NULL,'" + status + "','N','" + Session["userID"].ToString() + "',GETDATE(),'" + classification_grade1.Trim() + "','" + rate + "')";
        //                    }
        //                    else
        //                    {
        //                        strsql = strsql + "Values('" + headerid + "','" + baleno.Trim() + "','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + netwt.Trim() + "','" + withFreightRate + "','" + totalprice + "','" + buyergrade.Trim() + "','" + crop + "','" + variety + "','FW','" + rejests + "','" + rejetype + "','" + status + "','N','" + Session["userID"].ToString() + "',GETDATE(),'" + classification_grade1.Trim() + "','" + rate + "')";
        //                    }
        ...
        //                bool b = dlMgt.UpdateUsingExecuteNonQueryList(lstString);
        //                if (b)
        //                {
        //                    data = "Success: Data Uploaded Successfully";
        //                    json = JsonConvert.SerializeObject(data);
                ...
                for (int s = 0; s < orgdata.Rows.Count; s++)
                {
                    ...
                    for (int d = 0; d < purdata.Tables.Count; d++)
                    {
                        ...
                        for (int h = 0; h < purdata.Tables[d].Rows.Count; h++)
                        {
                            ...
                            withFreightRate = Convert.ToDouble(rate) + Convert.ToDouble(FreightRate);
                            strsql = "insert into GPIL_STOCK(GPIL_BALE_NUMBER,SUBINVENTORY_CODE,TB_LOT_NO,TBGR_NO,TB_GRADE,BUYER_GRADE,MARKED_WT,CURR_WT,ORIGN_LOCN,ORIGN_ORGN_CODE,CROP,VARIETY,PRICE,PRODUCT_TYPE,PROCESS_STATUS,BATCH_NO,STATUS,CREATED_BY,CREATED_DATE,LAST_UPDATED_BY,LAST_UPDATED_DATE,WEIGHT_FLAG,BALE_CARD_TYPE,CURR_LOCN,CURR_ORGN_CODE,GRADE)";
                            strsql = strsql + "Values('" + baleno.Trim() + "','CL','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + buyergrade.Trim() + "','" + netwt.Trim() + "','" + netwt.Trim() + "','LOC1','" + orgcd.Trim() + "','" + crop + "','" + variety + "','" + rate.Trim() + "','G','Y','" + headerid + "','" + stockstatus + "','" + Session["userID"].ToString() + "',GETDATE(),'" + Session["userID"].ToString() + "',GETDATE(),'N','FARM','LOC1','" + orgcd + "','" + classification_grade1.Trim() + "')";
                            ...
                            if (rejetype == "NONE")
                            {
                                strsql = strsql + "Values('" + headerid + "','" + baleno.Trim() + "','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + netwt.Trim() + "','" + withFreightRate + "','" + totalprice + "','" + buyergrade.Trim() + "','" + crop + "','" + variety + "','CL','" + rejests + "',NULL,'" + status + "','N','" + Session["userID"].ToString() + "',GETDATE(),'" + classification_grade1.Trim() + "','" + rate + "')";
                            }
                            else
                            {
                                strsql = strsql + "Values('" + headerid + "','" + baleno.Trim() + "','" + tblot.Trim() + "','" + tbgrno.Trim() + "','" + tbgrade.Trim() + "','" + netwt.Trim() + "','" + withFreightRate + "','" + totalprice + "','" + buyergrade.Trim() + "','" + crop + "','" + variety + "','CL','" + rejests + "','" + rejetype + "','" + status + "','N','" + Session["userID"].ToString() + "',GETDATE(),'" + classification_grade1.Trim() + "','" + rate + "')";
                            }
            ...
            try
            {
                ...
                for (int s = 0; s < orgdata.Rows.Count; s++)
                {
                    ...
                    for (int d = 0; d < purdata.Tables.Count; d++)
                    {
                        ...
                        /// Generating Header Id
                        string baleno1 = purdata.Tables[d].Rows[0]["GPIL_BALE_NUMBER"].ToString();
                        string headerid = "SR" + purdata.Tables[d].Rows[0]["SUPP_CODE"].ToString() + purdata.Tables[d].Rows[0]["RECEV_ORG_CODE"].ToString() + DateTime.Now.ToString("yyMMddHHmmss");
                        //strsql = "select * from GPIL_SUPP_PURCHS_HDR where HEADER_ID like '%" + temphdr + "%'";
                        DataTable ds1 = new DataTable();
                        //ds1 = dlMgt.GetQueryResult(strsql);
                        //if (ds1.Rows.Count > 0)
            ...
            try
            {
                    ...
                    for (int d = 0; d < purdata.Tables.Count; d++)
                    {
                        for (int h = 0; h < purdata.Tables[d].Rows.Count; h++)
                        {
                            ...
                            else
                            {
                                ...
                                strsql = "select MARKED_WT,PROCESS_STATUS,SUBINVENTORY_CODE ,Price from GPIL_STOCK where GPIL_BALE_NUMBER='" + baleno1 + "' and CURR_ORGN_CODE='" + currorg + "' AND STATUS='Y'";
                                ds1 = dlMgt.GetQueryResult(strsql);
                ...
                for (int d = 0; d < purdata.Tables.Count; d++)
                {
                    ...
                    for (int h = 0; h < purdata.Tables[d].Rows.Count; h++)
                    {
                        ...
                        if (orgntype == "TAP")
                        {
                            strsql = "select MARKED_WT,PROCESS_STATUS,CURR_WT,BUYER_GRADE,PRICE from GPIL_STOCK where GPIL_BALE_NUMBER='" + baleno + "'";
                        }
                        else
                        {
                            strsql = "select MARKED_WT,PROCESS_STATUS,CURR_WT,GRADE,PRICE from GPIL_STOCK where GPIL_BALE_NUMBER='" + baleno + "'";
                        }
                        ...
                        if (ds1.Rows.Count > 0)
                        {
                            ...
                            diswt = Convert.ToString(ds1.Rows[0][2]);
                            grade = Convert.ToString(ds1.Rows[0][3]);
                            attribute2 = Convert.ToString(ds1.Rows[0][4]);
                        }
                        ...
                        strsql = "INSERT INTO [GPIL_SHIPMENT_DTLS_TEMP]([SHIPMENT_NO],[DETAIL_ID],[GPIL_BALE_NUMBER],[MARKED_WT],[DISPATCH_WEIGHT],[FROM_SUBINVENTORY_CODE],[TO_SUBINVENTORY_CODE],[LOADING_DATETIME],[STATUS],[HEADER_STATUS],[CREATED_BY],[CREATED_DATE],[GRADE],[ATTRIBUTE2])";
                        strsql = strsql + "Values('" + temphdr + "','SH" + sendorg + DateTime.Now.ToString("yyyyMMddhhmmss") + d + h + "','" + baleno.Trim() + "','" + markedwt.Trim() + "','" + diswt.Trim() + "','" + fromsubcode.Trim() + "','" + tosubcode.Trim() + "','" + Convert.ToDateTime(loadtime).ToString("yyyy-MM-dd HH:mm:ss") + "','INT','N','" + Session["userID"].ToString() + "',GETDATE(),'" + grade.Trim() + "','" + attribute2.Trim() + "')";
                        //dlMgt.UpdateUsingExecuteNonQuery(strsql);
                        lstQry.Add(strsql);
        ...
        public JsonResult SalesTransactionComplete(ListSales LS)
        {
            ...
            try
            {
                ...
                for (int d = 0; d < purdata.Tables.Count; d++)
                {
                    ...
                    strsql = "INSERT INTO [GPIL_SO_RESERVATION_HDR_TEMP]([SHIPMENT_NO],[SENDER_ORGN_CODE],[RECEIVER_ORGN_CODE],[SENDER_DATE],[SENT_BY],[SENDER_TRUCK_NO] ,[RC_NO],[DRIVER_NAME],[DRIVING_LICENCE_NO],[TRANSPORT_NAME],[FRIEGHT_CHARGES],[UOM],[CREATED_BY],[CREATED_DATE],[STATUS],[ATTRIBUTE2],[ATTRIBUTE3],TOT_NO_OF_BALES)";
                    strsql = strsql + " VALUES('" + temphdr + "','" + sendorg + "','" + recevorg + "','" + Convert.ToDateTime(senddate).ToString("yyyy-MM-dd HH:mm:ss") + "','" + sendby + "','" + truckno + "','" + rcno + "','" + drivername + "','" + licenceno + "','" + transportname + "','0','KG','" + Session["userID"].ToString() + "',GETDATE(),'INT','" + sndorgty + "','" + rcvorgtyp + "'," + purdata.Tables[d].Rows.Count + ")";
                    //strsql = strsql + " VALUES('" + temphdr + "','" + sendorg + "','" + recevorg + "',GETDATE(),'" + sendby + "','" + truckno + "','" + rcno + "','" + drivername + "','" + licenceno + "','" + transportname + "','" + frightchrgs + "','KG','"+Propertycls.EMPCODE+"',GETDATE(),'INT')";
                    dlMgt.UpdateUsingExecuteNonQuery(strsql);
                    for (int h = 0; h < purdata.Tables[d].Rows.Count; h++)
                    {
                    ...
                    //}
                    string SPName = "GPIL_SP_SALES_WEBNEW";
                    List<SqlParameter> parameters = new List<SqlParameter>();
                    SqlParameter[] pram = new SqlParameter[3];
                    pram[0] = (new SqlParameter("@SHIPMENT_NO", SqlDbType.NVarChar, 50));
                    pram[1] = (new SqlParameter("@RESULT", SqlDbType.NVarChar, 1));
                    pram[2] = (new SqlParameter("@OUTPUT", SqlDbType.NVarChar, 1000));
                    pram[0].Value = temphdr;
                    pram[1].Direction = ParameterDirection.Output;
        ...
        public JsonResult ClassificationComplete(ListClassificationLoader LC)
        {
            ...
            try
            {
                ...
                for (int s = 0; s < orgdata.Rows.Count; s++)
                {
                    ...
                    purdata.Tables[s].Columns.Add("INS_STS");
            ...
            try
            {
                ...
                for (int d = 0; d < purdata.Tables.Count; d++)
                {
                    ...
                    for (h = 0; h < purdata.Tables[d].Rows.Count; h++)
                    {
                        ...
                        //totqty =  Convert.ToDouble(weight)-totqty ;
                        if (totqty < 0)
                        {
        ...
        public JsonResult CropTransferComplete(ListCropTransferLoader LCT)
        {
            ...
            try
            {
                ...
                for (int d = 0; d < purdata.Tables.Count; d++)
                {
                    ...
                    string SPName = "CROPTRANSFERPROCESS";
                    List<SqlParameter> parameters = new List<SqlParameter>();
                    // Create the @sts parameter and set its default value
                    SqlParameter stsParameter = new SqlParameter("@sts", SqlDbType.VarChar, 50)
                    {
                        Direction = ParameterDirection.Output,
                        Value = "1" // Set your default value here
                    };
                    parameters.Add(stsParameter);
        ...
        public JsonResult ThreshingIssueComplete(ListThreshingIssueLoader LTI)
        {
            ...
            try
            {
                    ...
                    for (int h = 0; h < purdata.Tables[d].Rows.Count; h++)
                    {
                        ...
                        else
                        {
                            ...
                            if (ds.Rows.Count > 0)
                            {
                                ...
                                processts = ds.Rows[0][1].ToString();
                ...
                if (b)
                {
                    var succssMsg = "Data Inserted SucessFully";
                    data = "Success:" + succssMsg;
                    json = JsonConvert.SerializeObject(data);
                    jsonResult = Json(json.ToString(), JsonRequestBehavior.AllowGet);
                    jsonResult.MaxJsonLength = int.MaxValue;
                    return jsonResult;
...

        {
            ...
            try
            {
                ...
                data = "Success: Data Uploaded "+ successMsg;
                json = JsonConvert.SerializeObject(data);
                jsonResult = Json(json.ToString(), JsonRequestBehavior.AllowGet);
                jsonResult.MaxJsonLength = int.MaxValue;
                return jsonResult;
