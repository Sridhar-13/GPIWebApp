<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="BuyserMaxMinReportVKBU.aspx.cs" Inherits="GPILWebApp.CrystalReport.WebForms.LPD.BuyserMaxMinReportVKBU" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9">Buyer Classification Report Without Transport Charge</h2>
    </div>
    ...
    <div class="page-content" style="background-color: white">
        ...
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="BCMinMaxWithTransChrRpt" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
