...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9">Buyer Classification Report</h2>
    </div>
    ...
    <div class="page-content" style="background-color: white">
        ...
        <div class="row mb-0">
            <div class="col-sm-3">
                <div class="form-sm-3-md-4">
                    ...
                    <div class="form-control-sm">
                        <asp:TextBox ID="txt_Report_Date" runat="server" CssClass="form-control" TextMode="Date" EnableViewState="true">                            
                        </asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvMDate" runat="server" ControlToValidate="txt_Report_Date"
                ...
                <div class="form-sm-3-md-4">
                    ...
                    <div class="form-control-sm">
                        <asp:RadioButton runat="server" ID="rdoWithFreight"
                            GroupName="VLB1" Text="With Freight" ForeColor="Black" Checked="True" />
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="form-sm-3-md-4">
                    ...
                    <div class="form-control-sm">
                        <asp:RadioButton runat="server" ID="rdoWithoutFreight"
                            GroupName="VLB1" Text="Without Freight" ForeColor="Black" />
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
        ...
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="BuyerClassReport" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
        ...
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="BuyerClassReport1" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
