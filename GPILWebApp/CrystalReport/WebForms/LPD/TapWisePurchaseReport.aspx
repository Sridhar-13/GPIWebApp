<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="TapWisePurchaseReport.aspx.cs" Inherits="GPILWebApp.TapWisePurchaseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9">GPI Purchase Summary Report</h2>
    </div>
    ...
    <button onclick="getOption()">Check option</button>--%>
        ...
        <div class="col-sm-12 mb-0" style="width:100%">
            <CR:CrystalReportViewer ID="TAP_Wise_Purchase_Report" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
  ...
  <%-- <script type="text/javascript">
       ...
       function getOption() {
           debugger;
        selectElement = document.querySelector('#cbxcrop');
