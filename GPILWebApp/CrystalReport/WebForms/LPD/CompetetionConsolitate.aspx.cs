        ...
        private void bindReport()
        {
            ...
            try
            {
                ...
                if (validate())
                {
                    ...
                    {
                        sql = "SELECT '" + txtDate.Text + "' AS REPORTDATE,H.ORGN_CODE,H.ORGN_CODE+' - '+O.ORGN_NAME as ORGN_NAME,H.CROP+' - '+CP.CROP_YEAR AS CROP,H.VARIETY+' - '+V.VARIETY_NAME AS VARIETY,TOT_SOLD_BALES,NB_NS_BALES,TOT_OFF_BALES,FLOOR_HB, ";
