    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-sm-3-md-4">
               ...
               <%-- <div>--%>
                    <asp:label id="lblRunYear" runat="server" style="color:red"></asp:label>
               <%-- </div>--%>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-sm-3-md-4">
               ...
               <%-- <div>--%>
                    <asp:label id="lblGradeName" runat="server" style="color:red"></asp:label>
               <%-- </div>--%>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-sm-3-md-4">
                ...
                <%--<div>--%>
                    <asp:label id="lblLocationName"  runat="server" style="color:red"></asp:label>
               <%-- </div>--%>
            </div>
        </div>
...
<%--                    <asp:TextBox ID="txtTo" runat="server" class="form-control" ReadOnly>                            
                    ...
                    <asp:TextBox ID="txtTo" runat="server" class="form-control" ReadOnly Visible="false">
</asp:TextBox>
                    <asp:TextBox ID="txtTo1" runat="server" class="form-control" ReadOnly>
</asp:TextBox>
                </div>
            </div>
        </div>
            ...
            <div class="form-sm-3-md-4">
                ...
                <div class="form-control-sm">
                 <%--   <asp:TextBox ID="txtNoOfCasesPrint" runat="server" class="form-control" OnTextChanged="txtNoOfCasesPrint_TextChanged">                            
                     ...
                     <asp:TextBox ID="txtNoOfCasesPrint" runat="server" AutoPostBack="true" class="form-control" OnTextChanged="txtNoOfCasesPrint_TextChanged"></asp:TextBox>
                </div>
            </div>
        </div>
    <div class="col-sm-6">
            <div class="form-sm-3-md-4">
        <asp:label id="lblTStartCaseNo" runat="server" style="color:red"></asp:label>
    </div>
        </div>
        </div>
...
<%--<script type="application/javascript" >
    ...
    $('#btnBack').on('click', function (event) {
        window.location = "/WmsPrintAllocations/Index";
    });
</script>--%>