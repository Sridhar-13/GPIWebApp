<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="GradeWiseStockAllReport.aspx.cs" Inherits="GPILWebApp.CrystalReport.WebForms.REPORTS.GradeWiseStockAllReport" %>
   ...
   <div class="header">
      ...
      <div class="row">
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
        <asp:RadioButton ID="rdbtapstk" runat="server" Text="TAP Stock" OnCheckedChanged="rdbTapStock_CheckedChanged" AutoPostBack="true" GroupName="LotWise" />
