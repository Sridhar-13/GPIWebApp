<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="AuctionFloorInvoiceRpt.aspx.cs" Inherits="GPILWebApp.CrystalReport.WebForms.REPORTS.AuctionFloorInvoiceRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="page-content" style="background-color: white">
        ...
        <div class="col-sm-12 mb-0" style="width: 100%">
            <CR:CrystalReportViewer ID="rdlcAuctionInvoiceReport" runat="server" AutoDataBind="true" ToolPanelView="None" HasCrystalLogo="False" />
