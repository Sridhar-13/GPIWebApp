<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="LP5Printing.aspx.cs" EnableEventValidation="false" Inherits="GPILWebApp.LP5Printing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content" style="background-color: white">
        ...
        <h4 class="header green">LP5 PRINT</h4>
