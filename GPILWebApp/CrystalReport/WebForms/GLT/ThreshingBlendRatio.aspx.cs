    ...
    public partial class ThreshingBlendRatio : System.Web.UI.Page
    {
        ...
        public void FuncGetItemList()
        {
            try
            {
                ...
                string sql = "SELECT ITEM_DESC FROM GPIL_ITEM_MASTER WHERE ITEM_CODE IN (SELECT DISTINCT PACKED_GRADE  FROM GPIL_THRESH_RECON_DTLS_2 D,GPIL_THRESH_RECON_HDR H WHERE H.BATCH_NO =D.BATCH_NO AND H.DATE_OF_OPERATION BETWEEN CONVERT(DATETIME,'" + txt_From_Date.Text + " 00:00:00',102) AND CONVERT(DATETIME,'" + txt_To_Date.Text + " 23:59:59',102)   AND H.CROP='" + ddlCrop.Text + "' AND H.VARIETY='" + ddlVariety.Text + "') ORDER BY ITEM_DESC";
        ...
        public void viewrpt()
        {
            ...
            //DateTime dt3 = Convert.ToDateTime(txt_To_Date.Text);
            //txt_To_Date.Text = dt3.ToString("dd-MM-yyyy");
            try
            {
                ...
                if (rdbIssueBlendRatio.Checked == true)
                {
                    ...
                    strsql = "SELECT D1.BATCH_NO,D1.GRADE,ROUND(SUM(MARKED_WT),2) AS QUANTITY,'" + ddlCrop.Text + "' AS CROP,'" + ddlVariety.SelectedItem.ToString() + "' AS VARIETY,'" + ddlPackedGrade.Text + "' AS PACKED_GRADE,'" + txt_From_Date.Text + "' AS FROM_DATE,'" + txt_To_Date.Text + "' AS TO_DATE,'INCREDIENT' AS BALE_TYPE FROM GPIL_THRESH_RECON_DTLS_1 D1 WHERE D1.BATCH_NO IN (SELECT D.BATCH_NO FROM GPIL_THRESH_RECON_DTLS_2 D,GPIL_THRESH_RECON_HDR H WHERE H.BATCH_NO=D.BATCH_NO AND H.DATE_OF_OPERATION BETWEEN CONVERT(DATETIME,'" + txt_From_Date.Text + " 00:00:00',102) AND CONVERT(DATETIME,'" + txt_To_Date.Text + " 23:59:59',102) AND H.CROP='" + ddlCrop.Text + "' AND H.VARIETY='" + ddlVariety.Text + "' AND D.PACKED_GRADE IN (SELECT ITEM_CODE FROM GPIL_ITEM_MASTER WHERE ITEM_DESC='" + ddlPackedGrade.Text + "')) AND D1.BALE_TYPE='IPB' GROUP BY D1.BATCH_NO,D1.GRADE ORDER BY D1.BATCH_NO,D1.GRADE";

                }
                else
                {
                    strsql = "SELECT D.BATCH_NO,I.ITEM_DESC + ' (' + D.PACKED_GRADE + ')' AS GRADE,ROUND(SUM(NET_WT),2) AS QUANTITY,'" + ddlCrop.Text + "' AS CROP,'" + ddlVariety.SelectedItem.ToString() + "' AS VARIETY,'" + ddlPackedGrade.Text + "' AS PACKED_GRADE,'" + txt_From_Date.Text + "' AS FROM_DATE,'" + txt_To_Date.Text + "' AS TO_DATE,'PRODUCT' AS BALE_TYPE  FROM GPIL_THRESH_RECON_DTLS_2 D, GPIL_THRESH_RECON_HDR H,GPIL_ITEM_MASTER I WHERE H.DATE_OF_OPERATION BETWEEN CONVERT(DATETIME,'" + txt_From_Date.Text + " 00:00:00',102) AND CONVERT(DATETIME,'" + txt_To_Date.Text + " 23:59:59',102) AND H.CROP='" + ddlCrop.Text + "' AND H.VARIETY='" + ddlVariety.Text + "' AND I.ITEM_DESC='" + ddlPackedGrade.Text + "' AND H.BATCH_NO=D.BATCH_NO AND H.CROP='" + ddlCrop.Text + "' AND H.VARIETY='" + ddlVariety.Text + "' AND PACKED_GRADE=I.ITEM_CODE GROUP BY D.BATCH_NO,I.ITEM_DESC,D.PACKED_GRADE UNION SELECT D1.BATCH_NO,D1.GRADE,ROUND(SUM(MARKED_WT),2) AS QUANTITY,'" + ddlCrop.Text + "' AS CROP,'" + ddlVariety.SelectedItem.ToString() + "' AS VARIETY,'" + ddlPackedGrade.Text + "' AS PACKED_GRADE,'" + txt_From_Date.Text + "' AS FROM_DATE,'" + txt_To_Date.Text + "' AS TO_DATE,'BY-PRODUCT' AS BALE_TYPE FROM GPIL_THRESH_RECON_DTLS_1 D1 WHERE D1.BATCH_NO IN (SELECT D.BATCH_NO FROM GPIL_THRESH_RECON_DTLS_2 D,GPIL_THRESH_RECON_HDR H WHERE H.BATCH_NO=D.BATCH_NO AND H.DATE_OF_OPERATION BETWEEN CONVERT(DATETIME,'" + txt_From_Date.Text + " 00:00:00',102) AND CONVERT(DATETIME,'" + txt_To_Date.Text + " 23:59:59',102) AND H.CROP='" + ddlCrop.Text + "' AND H.VARIETY='" + ddlVariety.Text + "' AND D.PACKED_GRADE IN (SELECT ITEM_CODE FROM GPIL_ITEM_MASTER WHERE ITEM_DESC='" + ddlPackedGrade.Text + "')) AND D1.BALE_TYPE='OPB' GROUP BY D1.BATCH_NO,D1.GRADE ORDER BY BATCH_NO,GRADE";
                    ...
                    //strsql = "SELECT D.BATCH_NO,I.ITEM_DESC + ' (' + D.PACKED_GRADE + ')' AS GRADE,ROUND(SUM(NET_WT),2) AS QUANTITY,'" + ddlCrop.Text + "' AS CROP,'" + ddlVariety.SelectedItem.ToString() + "' AS VARIETY,'" + ddlPackedGrade.Text + "' AS PACKED_GRADE,'" + txt_From_Date.Text + "' AS FROM_DATE,'" + txt_To_Date.Text + "' AS TO_DATE,'PRODUCT' AS BALE_TYPE  FROM GPIL_THRESH_RECON_DTLS_2 D, GPIL_THRESH_RECON_HDR H,GPIL_ITEM_MASTER I WHERE H.DATE_OF_OPERATION BETWEEN '" + txt_From_Date.Text + "' AND '" + txt_To_Date.Text + "' AND H.CROP='" + ddlCrop.Text + "' AND H.VARIETY='" + ddlVariety.Text + "' AND I.ITEM_DESC='" + ddlPackedGrade.Text + "' AND H.BATCH_NO=D.BATCH_NO AND H.CROP='" + ddlCrop.Text + "' AND H.VARIETY='" + ddlVariety.Text + "' AND PACKED_GRADE=I.ITEM_CODE GROUP BY D.BATCH_NO,I.ITEM_DESC,D.PACKED_GRADE UNION SELECT D1.BATCH_NO,D1.GRADE,ROUND(SUM(MARKED_WT),2) AS QUANTITY,'" + ddlCrop.Text + "' AS CROP,'" + ddlVariety.SelectedItem.ToString() + "' AS VARIETY,'" + ddlPackedGrade.Text + "' AS PACKED_GRADE,'" + txt_From_Date.Text + "' AS FROM_DATE,'" + txt_To_Date.Text + "' AS TO_DATE,'BY-PRODUCT' AS BALE_TYPE FROM GPIL_THRESH_RECON_DTLS_1 D1 WHERE D1.BATCH_NO IN (SELECT D.BATCH_NO FROM GPIL_THRESH_RECON_DTLS_2 D,GPIL_THRESH_RECON_HDR H WHERE H.BATCH_NO=D.BATCH_NO AND H.DATE_OF_OPERATION BETWEEN '" + txt_From_Date.Text + "' AND '" + txt_To_Date.Text + "' AND H.CROP='" + ddlCrop.Text + "' AND H.VARIETY='" + ddlVariety.Text + "' AND D.PACKED_GRADE IN (SELECT ITEM_CODE FROM GPIL_ITEM_MASTER WHERE ITEM_DESC='" + ddlPackedGrade.Text + "')) AND D1.BALE_TYPE='OPB' GROUP BY D1.BATCH_NO,D1.GRADE ORDER BY BATCH_NO,GRADE";
        ...
        {
            Response.Redirect("ThreshingBlendRatio.aspx");
        }
    }
}