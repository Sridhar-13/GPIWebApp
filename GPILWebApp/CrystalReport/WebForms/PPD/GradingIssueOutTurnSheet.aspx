        ...
        <div class="row mb-0">
            <div class="col-sm-3">
                <div class="form-sm-3-md-4">
                    ...
                    <div class="form-control-sm">
                        <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control" TextMode="Date" EnableViewState="true">                            
                        </asp:TextBox>
                ...
                <div class="form-sm-3">
                    ...
                    <div>
                        <asp:DropDownList runat="server" CssClass="form-control" ID="ddlBatchNo"></asp:DropDownList>
                         <asp:ListItem Value="0">SELECT BATCH NO</asp:ListItem>
                    </div>
                </div>
            </div>
