<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="BatchwiseClassificationRpt.aspx.cs" Inherits="GPILWebApp.BatchwiseClassificationRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="header">
        <h2 style="text-align: center; font-weight: bold; font-family: 'Times New Roman'; color: #438EB9">Classification Report</h2>
    </div>
        ...
        <div class="row mb-0">
            ...
            <div class="col-sm-4">
                <div class="form-sm-3">
                    ...
                    <div>
                        <asp:DropDownList runat="server" CssClass="form-control" ID="ddlOrgn" AutoPostBack="true" OnSelectedIndexChanged="cbxorgcd_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                </div>
            </div>
             ...
             <div class="col-sm-4">
                <div class="form-sm-3">
                    <label class="control-label">Select Batch No </label>
                    <div>
