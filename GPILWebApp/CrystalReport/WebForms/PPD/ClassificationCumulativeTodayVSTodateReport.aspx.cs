    ...
    public partial class ClassificationCumulativeTodayVSTodateReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if(ddlVariety.SelectedIndex!=0|| ddlOrganization.SelectedIndex != 0)
                    {
                        viewrpt();
                    }
                }
        ...
        public void viewrpt()
        {
            try
            {
                ...
                ClassificationDate = dtt.ToString("dd-MM-yyyy");

                string strsql = "";

                if (ddlOrganization.SelectedIndex == 0)
                {
                    strsql = "SELECT TBL1.SEQNO,TBL1.CLASSIFICATION_GRADE,ISNULL(TBL2.TODAY_BALES,'0') AS TODAY_BALES,ISNULL(TBL2.TODAY_QTY,'0') AS TODAY_QTY,ISNULL(TBL2.TODAY_AVEPRICE,'0') AS TODAY_AVEPRICE,TBL1.TODATE_BALES,TBL1.TODATE_QTY,TBL1.TODATE_AVEPRICE,TBL1.CROP,TBL1.VARIETY,TBL1.VARIETY_NAME,TBL1.ORGN_NAME,TBL1.TODATE FROM (SELECT ISNULL(CONVERT( INT,I.ATTRIBUTE1),0) AS SEQNO,I.ITEM_CODE_GROUP as CLASSIFICATION_GRADE,COUNT(D.GPIL_BALE_NUMBER) AS TODATE_BALES,SUM(D.NET_WT) as TODATE_QTY ,ROUND(SUM(D.VALUE)/SUM(D.NET_WT),2) as TODATE_AVEPRICE,O.ORGN_CODE+' - '+O.ORGN_NAME AS ORGN_NAME,H.CROP AS CROP,H.VARIETY AS VARIETY,V.VARIETY_NAME AS VARIETY_NAME,'" + ClassificationDate + "' AS TODATE FROM GPIL_TAP_FARM_PURCHS_DTLS (NOLOCK) D,GPIL_TAP_FARM_PURCHS_HDR (NOLOCK) H,GPIL_ORGN_MASTER (NOLOCK) O,GPIL_VARIETY_MASTER (NOLOCK) V ,GPIL_CLASSIFICATION_DTLS (NOLOCK) C ,GPIL_ITEM_MASTER (NOLOCK) I,GPIL_CLASSIFICATION_HDR (NOLOCK) HC where HC.BATCH_NO=C.BATCH_NO AND ISNULL(HC.ATTRIBUTE3,'')<>'N' AND I.ITEM_CODE=C.CLASSIFICATION_GRADE AND HC.RECIPE_CODE='CLASSIFICATION' AND O.ORGN_CODE=H.ORGN_CODE AND D.HEADER_ID=H.HEADER_ID AND D.GPIL_BALE_NUMBER=C.GPIL_BALE_NUMBER  AND V.VARIETY=H.VARIETY and D.STATUS!='N' and H.CROP='" + ddlCrop.Text + "' and H.VARIETY='" + ddlVariety.Text + "' and  HC.CLASSIFICATION_DATE <= CONVERT(datetime,'" + ClassificationDate + " 23:59:59 PM',105) group by O.ORGN_CODE+' - '+O.ORGN_NAME,H.CROP,H.VARIETY,V.VARIETY_NAME,I.ITEM_CODE_GROUP,I.ATTRIBUTE1) TBL1 FULL OUTER JOIN (SELECT ISNULL(CONVERT( INT,I.ATTRIBUTE1),0) AS SEQNO,I.ITEM_CODE_GROUP as CLASSIFICATION_GRADE,COUNT(D.GPIL_BALE_NUMBER) AS TODAY_BALES,SUM(D.NET_WT) as TODAY_QTY ,ROUND(SUM(D.VALUE)/SUM(D.NET_WT),2) as TODAY_AVEPRICE,O.ORGN_CODE+' - '+O.ORGN_NAME AS ORGN_NAME,H.CROP AS CROP,H.VARIETY AS VARIETY,V.VARIETY_NAME AS VARIETY_NAME,'" + ClassificationDate + "' AS TODATE FROM GPIL_TAP_FARM_PURCHS_DTLS D,GPIL_TAP_FARM_PURCHS_HDR H,GPIL_ORGN_MASTER O,GPIL_VARIETY_MASTER V ,GPIL_CLASSIFICATION_DTLS C ,GPIL_ITEM_MASTER I,GPIL_CLASSIFICATION_HDR HC where HC.BATCH_NO=C.BATCH_NO AND ISNULL(HC.ATTRIBUTE3,'')<>'N' AND I.ITEM_CODE=C.CLASSIFICATION_GRADE AND HC.RECIPE_CODE='CLASSIFICATION' AND O.ORGN_CODE=H.ORGN_CODE AND D.HEADER_ID=H.HEADER_ID AND D.GPIL_BALE_NUMBER=C.GPIL_BALE_NUMBER  AND V.VARIETY=H.VARIETY and D.STATUS!='N' and H.CROP='" + ddlCrop.Text + "' and H.VARIETY='" + ddlVariety.Text + "' and  CONVERT(NVARCHAR(15),HC.CLASSIFICATION_DATE,105) = '" + ClassificationDate + "' group by O.ORGN_CODE+' - '+O.ORGN_NAME,H.CROP,H.VARIETY,V.VARIETY_NAME,I.ITEM_CODE_GROUP,I.ATTRIBUTE1) TBL2 ON TBL1.CLASSIFICATION_GRADE=TBL2.CLASSIFICATION_GRADE AND TBL1.CROP=TBL2.CROP AND TBL1.VARIETY=TBL2.VARIETY AND TBL1.ORGN_NAME=TBL2.ORGN_NAME AND TBL1.VARIETY_NAME=TBL2.VARIETY_NAME ORDER BY TBL1.SEQNO,TBL1.CLASSIFICATION_GRADE";
                }
                else
                {
                    strsql = "SELECT TBL1.SEQNO,TBL1.CLASSIFICATION_GRADE,ISNULL(TBL2.TODAY_BALES,'0') AS TODAY_BALES,ISNULL(TBL2.TODAY_QTY,'0') AS TODAY_QTY,ISNULL(TBL2.TODAY_AVEPRICE,'0') AS TODAY_AVEPRICE,TBL1.TODATE_BALES,TBL1.TODATE_QTY,TBL1.TODATE_AVEPRICE,TBL1.CROP,TBL1.VARIETY,TBL1.VARIETY_NAME,TBL1.ORGN_NAME,TBL1.TODATE FROM (SELECT ISNULL(CONVERT( INT,I.ATTRIBUTE1),0) AS SEQNO,I.ITEM_CODE_GROUP as CLASSIFICATION_GRADE,COUNT(D.GPIL_BALE_NUMBER) AS TODATE_BALES,SUM(D.NET_WT) as TODATE_QTY ,ROUND(SUM(D.VALUE)/SUM(D.NET_WT),2) as TODATE_AVEPRICE,O.ORGN_CODE+' - '+O.ORGN_NAME AS ORGN_NAME,H.CROP AS CROP,H.VARIETY AS VARIETY,V.VARIETY_NAME AS VARIETY_NAME,'" + ClassificationDate + "' AS TODATE FROM GPIL_TAP_FARM_PURCHS_DTLS (NOLOCK) D,GPIL_TAP_FARM_PURCHS_HDR (NOLOCK) H,GPIL_ORGN_MASTER (NOLOCK) O,GPIL_VARIETY_MASTER (NOLOCK) V ,GPIL_CLASSIFICATION_DTLS (NOLOCK) C ,GPIL_ITEM_MASTER (NOLOCK) I,GPIL_CLASSIFICATION_HDR (NOLOCK) HC where HC.BATCH_NO=C.BATCH_NO AND ISNULL(HC.ATTRIBUTE3,'')<>'N' AND I.ITEM_CODE=C.CLASSIFICATION_GRADE AND HC.RECIPE_CODE='CLASSIFICATION' AND O.ORGN_CODE=H.ORGN_CODE AND D.HEADER_ID=H.HEADER_ID AND D.GPIL_BALE_NUMBER=C.GPIL_BALE_NUMBER  AND V.VARIETY=H.VARIETY and D.STATUS!='N' and H.CROP='" + ddlCrop.Text + "' and H.VARIETY='" + ddlVariety.Text + "' and H.ORGN_CODE='" + ddlOrganization.Text + "' and  HC.CLASSIFICATION_DATE <= CONVERT(datetime,'" + ClassificationDate + " 23:59:59 PM',105) group by O.ORGN_CODE+' - '+O.ORGN_NAME,H.CROP,H.VARIETY,V.VARIETY_NAME,I.ITEM_CODE_GROUP,I.ATTRIBUTE1) TBL1 FULL OUTER JOIN (SELECT ISNULL(CONVERT( INT,I.ATTRIBUTE1),0) AS SEQNO,I.ITEM_CODE_GROUP as CLASSIFICATION_GRADE,COUNT(D.GPIL_BALE_NUMBER) AS TODAY_BALES,SUM(D.NET_WT) as TODAY_QTY ,ROUND(SUM(D.VALUE)/SUM(D.NET_WT),2) as TODAY_AVEPRICE,O.ORGN_CODE+' - '+O.ORGN_NAME AS ORGN_NAME,H.CROP AS CROP,H.VARIETY AS VARIETY,V.VARIETY_NAME AS VARIETY_NAME,'" + ClassificationDate + "' AS TODATE FROM GPIL_TAP_FARM_PURCHS_DTLS D,GPIL_TAP_FARM_PURCHS_HDR H,GPIL_ORGN_MASTER O,GPIL_VARIETY_MASTER V ,GPIL_CLASSIFICATION_DTLS C ,GPIL_ITEM_MASTER I,GPIL_CLASSIFICATION_HDR HC where HC.BATCH_NO=C.BATCH_NO AND ISNULL(HC.ATTRIBUTE3,'')<>'N' AND I.ITEM_CODE=C.CLASSIFICATION_GRADE AND HC.RECIPE_CODE='CLASSIFICATION' AND O.ORGN_CODE=H.ORGN_CODE AND D.HEADER_ID=H.HEADER_ID AND D.GPIL_BALE_NUMBER=C.GPIL_BALE_NUMBER  AND V.VARIETY=H.VARIETY and D.STATUS!='N' and H.CROP='" + ddlCrop.Text + "' and H.VARIETY='" + ddlVariety.Text + "' and H.ORGN_CODE='" + ddlOrganization.Text + "' and  CONVERT(NVARCHAR(15),HC.CLASSIFICATION_DATE,105) = '" + ClassificationDate + "' group by O.ORGN_CODE+' - '+O.ORGN_NAME,H.CROP,H.VARIETY,V.VARIETY_NAME,I.ITEM_CODE_GROUP,I.ATTRIBUTE1) TBL2 ON TBL1.CLASSIFICATION_GRADE=TBL2.CLASSIFICATION_GRADE AND TBL1.CROP=TBL2.CROP AND TBL1.VARIETY=TBL2.VARIETY AND TBL1.ORGN_NAME=TBL2.ORGN_NAME AND TBL1.VARIETY_NAME=TBL2.VARIETY_NAME ORDER BY TBL1.SEQNO,TBL1.CLASSIFICATION_GRADE";
                }
