    ...
    public partial class ClassificationReportForTAP : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (cbxvariety.SelectedIndex != 0 && cbxorgcd.SelectedIndex != 0)
                    {
                        viewrpt();
                    }
                }
