        ...
        public void viewrpt()
        {
            ...
            try
            {
                ...
                if (ddlOrganizationCode.SelectedIndex != 0)
                    ds = ppdMgt.GradingReportPPD(frmDate, toDate, ddlCropYear.Text, ddlVariety.Text, ddlOperationReceipe.Text, ddlOrganizationCode.Text);
                else
                    ds = ppdMgt.GradingReportPPD(frmDate, toDate, ddlCropYear.Text, ddlVariety.Text, ddlOperationReceipe.Text, "");
