        ...
        public DataSet GetBuyerVSClassReport(string strFromDate, string strToDate,string strCrop,string strVariety,string strOrgnCode)
        {
            ...
            try
            {
                if (strOrgnCode == "0")
                {
                    ...
                    strSQL = strSQL + " H.RECIPE_CODE='CLASSIFICATION' and PH.CROP='" + strCrop + "' AND PH.VARIETY='" + strVariety + "' ";
                ...
                else
                {
                    ...
                    strSQL = strSQL + "  PH.CROP='" + strCrop + "' AND PH.VARIETY='" + strVariety + "' AND ";
                    strSQL = strSQL + "  PH.ORGN_CODE='" + strOrgnCode + "' AND H.CLASSIFICATION_DATE BETWEEN ";
